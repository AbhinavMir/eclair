...
class contract_PayeeContract_class:
    ...
    def call_function_Constructor(self, initialPayees: list) -> None:
        return self.call_function('Constructor', initialPayees)
    
    def call_function_Fallback(self) -> None:
        return self.call_function('Fallback')
    
    def call_function_Receive(self) -> None:
        return self.call_function('Receive')
    
    def call_function_addBalance(self, amount: int) -> None:
        return self.call_function('addBalance', amount)
    
    def call_function_addPayee(self, newPayee: str) -> None:
        return self.call_function('addPayee', newPayee)
    
    def execute_transaction_getAllPayees(self) -> (list):
        return self.execute_transaction('getAllPayees')
    
    def call_function_payableFunction(self) -> None:
        return self.call_function('payableFunction')
    
    def call_function_removePayee(self, payee: str) -> None:
        return self.call_function('removePayee', payee)
    
    def call_function_sendEth(self, amount: int, to: list) -> None:
        return self.call_function('sendEth', amount, to)
