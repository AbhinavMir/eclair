...
class contract_IUniswapV2Router_class:
    ...
    def call_function_swapExactTokensForTokens(self, amountIn: int, amountOutMin: int, path: list, to: str, deadline: int) -> (int):
        return self.call_function('swapExactTokensForTokens', amountIn, amountOutMin, path, to, deadline)
    
    def call_function_swapTokensForExactTokens(self, amountOut: int, amountInMax: int, path: list, to: str, deadline: int) -> (int):
        return self.call_function('swapTokensForExactTokens', amountOut, amountInMax, path, to, deadline)
