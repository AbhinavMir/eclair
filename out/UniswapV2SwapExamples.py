...
class contract_UniswapV2SwapExamples_class:
    ...
    def call_function_swapMultiHopExactAmountIn(self, amountIn: int, amountOutMin: int) -> (int):
        return self.call_function('swapMultiHopExactAmountIn', amountIn, amountOutMin)
    
    def call_function_swapMultiHopExactAmountOut(self, amountOutDesired: int, amountInMax: int) -> (int):
        return self.call_function('swapMultiHopExactAmountOut', amountOutDesired, amountInMax)
    
    def call_function_swapSingleHopExactAmountIn(self, amountIn: int, amountOutMin: int) -> (int):
        return self.call_function('swapSingleHopExactAmountIn', amountIn, amountOutMin)
    
    def call_function_swapSingleHopExactAmountOut(self, amountOutDesired: int, amountInMax: int) -> (int):
        return self.call_function('swapSingleHopExactAmountOut', amountOutDesired, amountInMax)
