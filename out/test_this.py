...
class contract_test_this_class:
    ...
    def call_function_addNewStudents(self, newStudents: list) -> (Tuple(list, str)):
        return self.call_function('addNewStudents', newStudents)
