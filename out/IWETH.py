...
class contract_IWETH_class:
    ...
    def execute_transaction_allowance(self, owner: str, spender: str) -> (int):
        return self.execute_transaction('allowance', owner, spender)
    
    def call_function_approve(self, spender: str, amount: int) -> (bool):
        return self.call_function('approve', spender, amount)
    
    def execute_transaction_balanceOf(self, account: str) -> (int):
        return self.execute_transaction('balanceOf', account)
    
    def call_function_deposit(self) -> None:
        return self.call_function('deposit')
    
    def execute_transaction_totalSupply(self) -> (int):
        return self.execute_transaction('totalSupply')
    
    def call_function_transfer(self, recipient: str, amount: int) -> (bool):
        return self.call_function('transfer', recipient, amount)
    
    def call_function_transferFrom(self, sender: str, recipient: str, amount: int) -> (bool):
        return self.call_function('transferFrom', sender, recipient, amount)
    
    def call_function_withdraw(self, amount: int) -> None:
        return self.call_function('withdraw', amount)
